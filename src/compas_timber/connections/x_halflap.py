...
class XHalfLapJoint(Joint):
    """Represents a X-Lap type joint which joins the ends of two beams,
    ...
    def add_features(self):
        ...
        self.features = [lap_feature_a, lap_feature_b]
    ...
    def _get_lap_depths(self):
        ...
        main_height = self.beam_a.height if self.main_ref_side_index % 2 == 0 else self.beam_a.width
        cross_height = self.beam_b.height if self.cross_ref_side_index % 2 == 0 else self.beam_b.width
